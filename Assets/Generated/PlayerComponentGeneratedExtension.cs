...
namespace Entitas {
    public partial class Entity {
        ...
        public Entity AddPlayer(int newId, string newName, UnityEngine.Color newColor) {
        ...
        public Entity ReplacePlayer(int newId, string newName, UnityEngine.Color newColor) {
            var component = CreateComponent<PlayerComponent>(ComponentIds.Player);
            component.Id = newId;
            component.Name = newName;
            component.Color = newColor;
